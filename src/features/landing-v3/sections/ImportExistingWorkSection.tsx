...
/**
 * Import existing season — exact desktop composition on every viewport.
 * Below 1100px the approved desktop canvas is uniformly scaled.
 */
export function ImportExistingWorkSection() {
  ...
  return (
    ...
    >
      ...
      <DesktopCompositionScale composition="import">
