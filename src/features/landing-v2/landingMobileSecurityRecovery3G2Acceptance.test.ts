...

{
  ...
  assertEq(MOBILE_TRACK_STUDIO_HISTORY_SVH_COMPACT, 58, 'studio intro 3G.3 continuous')
  ...
  assertEq(COMPACT_SECURITY_LOCK_LIFT_VH, 11.5, 'lift 50→38.5')
  assertEq(STUDIO_LOCK_Y_VH_END_COMPACT, -20.5, 'history lock Y 3G.3')
  assertEq(STUDIO_LOCK_SCALE_END_COMPACT, 0.28, 'history lock scale')
