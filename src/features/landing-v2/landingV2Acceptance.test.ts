...

{
  ...
  assertIncludes(mobile, 'compactIntro', 'compact History intro scrub; years document-flow')
  ...
  assertEq(MOBILE_TRACK_STUDIO_HISTORY_SVH_COMPACT, 58, 'compact studio intro runway 58svh')
  ...
  assertEq(studioCompactLockFadeAt(1), 1, 'compact sticky lock fade unused')
  {
    ...
    assertIncludes(historyReveal, "data-studio-history-compact={compactIntro ? 'intro' : 'false'}", 'desktop/compact history marker')
