...
export const SEMANTIC_MAP: SemanticMapping[] = [
  ...
  },
  {
    ...
    covers: ['coverage_hours', 'working_hours', 'package.coverageHours'],
    mode: 'single',
    minForFull: 1,
  },
  {
  ...
  },
  {
    ...
    covers: ['coverage_end_time', 'package.coverageEndTime'],
    mode: 'single',
    minForFull: 1,
  },
  {
