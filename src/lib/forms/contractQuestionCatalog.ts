...
export const CONTRACT_QUESTION_IDS = {
  ...
  GROOM_CONTRACT_ADDRESS: 'q-p2-address',
  CONTRACT_POSTAL: 'q-p1-postal',
  CONTRACT_CITY: 'q-p1-city',
  CONTACT_EMAIL: 'q-p1-email',
  GROOM_EMAIL: 'q-p2-email',
  PREPARATION_LOCATION: 'q-prep',
  BRIDE_PREPARATION_LOCATION: 'q-bride-prep',
  GROOM_PREPARATION_LOCATION: 'q-groom-prep',
...
> = {
  ...
  'groom.email': CONTRACT_QUESTION_IDS.GROOM_EMAIL,
  'groom.address': CONTRACT_QUESTION_IDS.GROOM_CONTRACT_ADDRESS,
  'location.preparation': CONTRACT_QUESTION_IDS.BRIDE_PREPARATION_LOCATION,
  'location.bridePreparation': CONTRACT_QUESTION_IDS.BRIDE_PREPARATION_LOCATION,
  'location.groomPreparation': CONTRACT_QUESTION_IDS.GROOM_PREPARATION_LOCATION,
...
> = {
  ...
  selectedPackageIds: CONTRACT_QUESTION_IDS.PACKAGE_SELECTOR,
  selectedAdditionalServiceIds: CONTRACT_QUESTION_IDS.EXTRAS_SELECTOR,
  ...
  'partner2.email': CONTRACT_QUESTION_IDS.GROOM_EMAIL,
  'partner2.address': CONTRACT_QUESTION_IDS.GROOM_CONTRACT_ADDRESS,
  preparationLocation: CONTRACT_QUESTION_IDS.PREPARATION_LOCATION,
  bridePreparationLocation: CONTRACT_QUESTION_IDS.BRIDE_PREPARATION_LOCATION,
  groomPreparationLocation: CONTRACT_QUESTION_IDS.GROOM_PREPARATION_LOCATION,
