...
export function IconWeddings(props: IconProps) {
  return (
    <svg {...defaults} {...props}>
...
/** Lucide Settings cog for Ustawienia. IconSettings keeps the sun glyph for catalog placeholders. */
...
/** Camera mark for Sessions (Sesje). */
