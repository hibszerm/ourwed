/**
 * V6-RI2 — Edge semantic verifier prompt/schema (Deno mirror of runtime).
 * Do not phrase-patch h19. Do not adjudicate capability.
 */
...
export function buildV6SemanticVerifyRequestBody(input: {
  model: string
  ...
  const base: Record<string, unknown> = {
    model: input.model,
    max_completion_tokens: input.maxOutputTokens ?? 1400,
