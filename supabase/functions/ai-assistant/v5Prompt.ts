/**
 * G8 — GoalSpec interpreter prompt (Edge / local harness).
 * Meaning only. No CRM facts, tools, IDs, SQL, DomainQuery.
 * Keep text aligned with src/features/assistant/v4/goalSpec/goalSpecInterpreterPrompt.ts
 */
