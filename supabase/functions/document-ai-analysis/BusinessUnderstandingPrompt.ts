/**
 * Diagnostic Pass 1 — business understanding only.
 * No registry IDs. No mapping. Understanding only.
 * KEEP IN SYNC with src/features/documents/ai/diagnostics/BusinessUnderstandingPrompt.ts
 */
...
export const BUSINESS_UNDERSTANDING_USER_MESSAGE =
  'Reverse-engineer this wedding-business contract. Understand the business, workflow, and which information changes between clients. Do NOT map to registry IDs. Do NOT return literal values from the document.\n\nDOCUMENT:\n'
